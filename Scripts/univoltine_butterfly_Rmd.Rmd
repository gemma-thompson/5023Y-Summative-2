...
This graph shows that the female and male butterflies are relatively not affected by the rain during the month of June.

\`\`\`{r plot 7} p1 \<- univolutine_butterfly %\>% ggplot(aes(x=jun_temp y=forewing_length))+ geom_point(aes(colour=species))+ scale_colour_manual(values= "lawngreen", "goldenrod")+ theme_minimal()+ labs = (x = "Mean temperature in June", y = "Forewing length", Title = "How temperature affects forewing length of male and female butterflies")

p2 \<- univolutine_butterfly %\>% ggplot(aes(x=rain_jun, y=forewing_length))+ geom_point(aes(colour=sex))+ scale_colour_manual(values= "lawngreen", "goldenrod")+ theme_minimal()+ labs = (x = "Rain in June", y = "Forewing length", Title = "How rain affects forewing length of male and female butterflies")
